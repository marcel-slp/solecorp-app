...
export const jogadorContainer = style({
  width: '100%',
  height: '100%',
  display: 'flex',
  color: 'black',
...
export const tableJogadorContainer = style({
  width: '100%',
  height: '100%',
  color: 'black',
...
export const addJogadorContainer = style({
  width: 'fit-content',
  display: 'grid',
  gridTemplateColumns: '1fr 1fr',
  rowGap: '20px',
...
export const jogadorInputs = style({
  width: 'fit-content'
});

export const jogadorDropdown = style({
  width: 'fit-content'
});
