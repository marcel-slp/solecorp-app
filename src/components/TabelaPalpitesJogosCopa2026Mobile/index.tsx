...
function TabelaPalpitesJogosCopa2026Mobile({
  bolaoId
}: TabelaPalpitesJogosCopa2026Mobile) {
  ...
  const {
    ...
    editarPremiosIndividuaisPalpite
  ...
  return (
    <Box>
      <Box className={styles.container}>
        <Box className={styles.premiosSection}>
      ...
      {ORDEM_FASES.map((fase) => {
        ...
        return (
          <Box key={fase} className={styles.faseContainer}>
            <Heading size="md" mb={4}>
              {fase}
            </Heading>
            <SimpleGrid
      ...
      <EscolherSelecaoModal
        isOpen={
          modalAberto === "campeao" ||
          modalAberto === "viceCampeao" ||
          modalAberto === "terceiroLugar" ||
          modalAberto === "melhor1Fase"
        }
        onClose={() => setModalAberto(null)}
        tipo={
          modalAberto as
        ...
        selecoesEscolhidas={
          modalAberto === "melhor1Fase"
            ? undefined
            : [campeaoInterno, viceCampeaoInterno, terceiroLugarInterno].filter(
                Boolean
              )
        }
      />
...
export default TabelaPalpitesJogosCopa2026Mobile;
